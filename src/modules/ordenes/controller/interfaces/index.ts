...
// index.ts o donde prefieras colocar tus interfaces

export interface ICotizacionesController {
    getCotizaciones(page: number, limit: number, id?: string): Promise<any>;
    deleteCotizacion(id?: string): Promise<any>;
    updateCotizacion(id: string, cotizacion: any): Promise<any>;
    createCotizacion(cotizacion: any): Promise<any>;
}

export interface ICotizacionesEstadosController {
    getCotizacionesEstados(page: number, limit: number, id?: string): Promise<any>;
    deleteCotizacionEstado(id?: string): Promise<any>;
    updateCotizacionEstado(id: string, cotizacionEstado: any): Promise<any>;
    createCotizacionEstado(cotizacionEstado: any): Promise<any>;
}
